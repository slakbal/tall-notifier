...
After `php artisan tall-notifier:install` command is fired, config file will be published to `config/tall-notifier.php`. There you can change some value for customization.
``` php
<?php
return [
